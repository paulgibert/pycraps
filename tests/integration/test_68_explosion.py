...
def test_6_8_explosion():
    ...
    assert state.get_bankroll_size() == 164.0

    state.step(Roll((6,6)))
    state.step(Roll((1,1)))
    state.step(Roll((5,4)))
    state.step(Roll((3,3))) # Hit!
    assert state.get_bankroll_size() == 185.0
    ...
    assert state.get_bankroll_size() == 161.0
    ...
    assert state.get_bankroll_size() == 196.0
    ...
    assert state.get_bankroll_size() == 376.0
